      ...
      <section className="bg-gradient-to-r from-stone-800 to-stone-700 py-12 border-y-4 border-orange-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-amber-100 mb-4">🎮 Prison Entertainment Zone</h2>
            <p className="text-amber-200">Interactive games and features to keep you engaged!</p>
          </div>
